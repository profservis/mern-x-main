...
// Добавим консольные выводы
console.log('MONGODB_CONNECTION:', process.env.MONGODB_CONNECTION);
console.log('PORT:', process.env.PORT);
console.log('REQUEST_LIMIT_NUMBER:', process.env.REQUEST_LIMIT_NUMBER);
console.log('REQUEST_LIMIT_TIME:', process.env.REQUEST_LIMIT_TIME);
console.log('MAX_JSON_SIZE:', process.env.MAX_JSON_SIZE);
console.log('URL_ENCODED:', process.env.URL_ENCODED);
console.log('WEB_CACHE:', process.env.WEB_CACHE);
