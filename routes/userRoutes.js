...
import { registerUser, loginUser, getUserProfile, updateUserProfile } from '../app/controllers/userController.js';
import { authenticateJWT } from '../app/middlewares/authMiddleware.js';
